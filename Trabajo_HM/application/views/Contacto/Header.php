...
<head>
    ...
    <title>Control Asistencia </title> <!--Titulo pestaña-->
    <!-- Bootstrap Core CSS -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       ...
                       <!--INICIO-->
                        ...
                        <li>
                            <a href="<?php echo base_url()?>index.php/asistencia"><i class="fa fa-table fa-fw"></i><b>Ver Asistencia </b><span class="fa arrow"></span></a>
                        </li>

                        <!--opciones agenda-->
                        <li>
                            <a href="<?=base_url()?>index.php/Contacto"><i class="fa fa-edit fa-fw"></i> Agenda Telefónica <span class="fa arrow"></span></a>
                    ...
                    <br>
                    <br>
                    <img class="img-responsive" src="<?php echo base_url(); ?>/imagenes/2.gif"/ width='100' height='100'>
                    </center>
                </div>
                <!-- /.sidebar-collapse -->
            </div>
