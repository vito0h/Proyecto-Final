...
<head>
    ...
    <title>Portal Administrativo </title> <!--Titulo pestaña-->
    <!-- Bootstrap Core CSS -->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="<?php echo base_url()?>index.php/Controlador/logueado_contador">Portal Administrativo, Bienvenido <?=$registro->Nombre?>!!</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                       ...
                       <!--INICIO-->
                        ...
                        <li>                           
                            ...
                            <li>    
                            <a href="#"><i class="fa fa-table fa-fw"></i> Agenda Telefónica <span class="fa arrow"></span></a>  
                            ...
                            <ul class="nav nav-third-level"> 
                              ...
                              <li>
                                ...
                                <li>
                                    <a href="#"><i class="fa fa-eraser"></i> Eliminar número<span class="fa arrow"></span></a>
                                </li>  
                             </li>      
                            </ul>
                            <li>
                        ...
                        <ul class="nav nav-second-level">
                         ...
                         <li>                           
                            <a href="#"><i class="fa fa-users fa-fw"></i><b>Profesores </b><span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-gear fa-fw"></i><b>Varios </b><span class="fa arrow"></span></a>
                ...
                <div class="col-lg-8"><!-- 3 -->
                    <div class="panel panel-default" ><!-- 4 -->
                        ...
                        <div class="panel-body"><!-- 6 -->
                                <img class="img-responsive" src="./imagenes/4.jpg"/>
